...
//Last modified: Wed, Jun 12, 2013 05:39:04 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 413.68474556456101 -203.40067887355087 -3567.3688497076787 ;
	setAttr ".r" -type "double3" 187.19999999999496 5.1999999999922206 -180 ;
	setAttr ".rpt" -type "double3" -9.2299171856657661e-013 7.6273786509816231e-013 
		1.055230491541159e-012 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 3165.6968600160221;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -132.47451046424123 811.74052284788468 -230.19658881531836 ;
...
createNode reference -n "AIE_Assemble2RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|AIE_Assemble2:maincamera|AIE_Assemble2:camera_AIE" "translate" " -type \"double3\" 789.747989 278.345344 -2031.221238"
		...
		" -type \"double3\" 0 0 0"
		2 "|AIE_Assemble2:maincamera|AIE_Assemble2:camera1_aim" "translate" " -type \"double3\" 837.253781 235.259303 -889.569433"
		...
		""
		5 3 "AIE_Assemble2RN" "AIE_Assemble2:Kick_023:AnimLayer1.solo" "AIE_Assemble2RN.placeHolderList[11]" 
		""
		5 3 "AIE_Assemble2RN" "AIE_Assemble2:Kick_023:AnimLayer1.parentLayer" 
		"AIE_Assemble2RN.placeHolderList[12]" "";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
...
connectAttr "AIE_Assemble2RN.phl[11]" ":BaseAnimation.chsl[9]";
connectAttr "AIE_Assemble2RN.phl[12]" ":BaseAnimation.cdly[9]";
