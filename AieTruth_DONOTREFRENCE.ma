...
//Last modified: Wed, Jun 12, 2013 05:18:35 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 314.8007974402737 180.55219624444081 -3539.2977436915344 ;
	setAttr ".r" -type "double3" -8.4000000000000874 -196.79999999999231 0 ;
	setAttr ".rpt" -type "double3" -9.2299171856657661e-013 7.6273786509816231e-013 
		1.055230491541159e-012 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 1660.4883155563102;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -24.881576949762557 78.945310401162118 -1953.0270158044425 ;
...
createNode reference -n "AIE_Assemble2RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"AIE_Assemble2RN" 0
		"AIE_Assemble2RN" 32
		2 "|AIE_Assemble2:AIE_logo" "visibility" " 1"
		2 "|AIE_Assemble2:AIE_logo" "translate" " -type \"double3\" 0 18.509804 0"
		
		2 "|AIE_Assemble2:AIE_logo" "rotate" " -type \"double3\" 0 -100 0"
		2 "|AIE_Assemble2:AIE_logo" "scale" " -type \"double3\" 12.700852 12.700852 12.700852"
		...
		2 "|AIE_Assemble2:maincamera|AIE_Assemble2:camera_AIE" "translate" " -type \"double3\" 774.357953 278.565268 -2037.093375"
		...
		" -type \"double3\" 0 0 0"
		2 "|AIE_Assemble2:maincamera|AIE_Assemble2:camera1_aim" "translate" " -type \"double3\" 817.611403 235.933072 -889.573229"
...
createNode animCurveTL -n "DavidAIEChacatersean:Character1_Ctrl_Reference_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -2788.7341819728254 80 -2788.7341819728254;
...
connectAttr "DavidAIEChacatersean:Character1_Ctrl_Reference_translateZ.o" "DavidAIEChacaterseanRN.phl[1]"
		;
connectAttr "DavidAIEChacatersean:Character1_Ctrl_Reference_translateY.o" "DavidAIEChacaterseanRN.phl[2]"
		;
connectAttr "DavidAIEChacatersean:Character1_Ctrl_Reference_translateX.o" "DavidAIEChacaterseanRN.phl[3]"
		;
